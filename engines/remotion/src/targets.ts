...
export const REMOTION_TARGETS: RemotionTargetCatalog = {
  short_cinematic_vertical: {
    ...
    kind: 'composition',
    compositionId: 'short_cinematic_vertical',
    width: 1080,
    height: 1920,
    fps: 60,
  ...
  linkedin_feed_4_5: {
    ...
    kind: 'still',
    compositionId: 'linkedin_feed_4_5',
    width: 1080,
    height: 1350,
    fps: 30,
    durationInFrames: 900,
  ...
  linkedin_carousel_square: {
    ...
    kind: 'still',
    compositionId: 'linkedin_carousel_square',
    width: 1080,
    height: 1080,
    fps: 30,
    durationInFrames: 900,
  ...
  youtube_essay_16_9: {
    ...
    kind: 'composition',
    compositionId: 'youtube_essay_16_9',
    width: 1920,
    height: 1080,
    fps: 30,
  ...
  youtube_thumbnail_16_9: {
    ...
    kind: 'still',
    compositionId: 'youtube_thumbnail_16_9',
    width: 1280,
    height: 720,
    fps: 30,
    durationInFrames: 900,
